        ...
        <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-700 p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">
              {language === 'ar'
                ? 'أدخل بياناتك لعرض مشاريعك'
                : 'Enter your credentials to view your projects'}
            </p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={language === 'ar' ? 'client@example.com' : 'client@example.com'}
                  required
                />
              </div>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400 text-sm">
              {language === 'ar' ? 'هل أنت موظف؟' : 'Are you an employee?'}{' '}
              <Link to="/employee/login" className="text-purple-400 hover:text-purple-300 font-semibold">
          ...
          <div className="mt-4 text-center">
            <p className="text-gray-500 text-xs">
              {language === 'ar'
                ? 'ليس لديك حساب؟ تواصل مع فريق الدعم'
                : "Don't have an account? Contact support team"}
            </p>
          </div>
        </div>
      </div>
